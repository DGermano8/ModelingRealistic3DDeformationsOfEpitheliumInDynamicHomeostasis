...
public:
    ...
    void TestPeriodicCubeWithGhosts() throw (Exception)
    {
        ...
        std::string output_directory = "PeriodicFixedWntFlow";
        ...
        double cut_off = 1.5;
        double density_threshold = 0.98*2.0*sqrt(3.0)/4.0;
        ...
        MAKE_PTR_ARGS(DensityDependantCellKillerStrip3DWithGhostNodesSimpleV2, density, (&cell_population, density_radius, density_threshold, periodic_width, periodic_height));
        ...
        simulator.SetSamplingTimestepMultiple(plot_step);
