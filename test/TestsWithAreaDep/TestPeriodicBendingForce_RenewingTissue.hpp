...
// #include "DensityDependantUniformCellKillerStrip3DWithGhostNodesSimpleV2.hpp"
...
public:
    ...
    void TestPeriodicCubeWithGhosts() throw (Exception)
    {
        ...
        std::string output_directory = "PeriodicBend_RenewingTissue_48hrs_12";
        ...
        for (typename AbstractCellPopulation<3>::Iterator cell_iter = cell_population.Begin();
         ...
         ++cell_iter)
        {
            cell_iter->GetCellData()->SetItem("angle_curvature", 6.283185307179586);
